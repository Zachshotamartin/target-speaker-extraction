...
The active direction is a [small concept demo](docs/CONCEPT_DEMO.md) for eight familiar voices, using changing clean mixtures and reserved evaluation recordings. Its first 600 updates completed in **24.2 minutes**, reaching **3.24 dB mean development improvement** across 32 requests. This remains below the quality target. The user authorized an **eight-hour continuation**, targeting 12,000 additional updates with automatic saving and stopping. [Live concept progress](http://127.0.0.1:8000/experiments/concept/) shows the actual run state and best development score.
