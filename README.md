...
The active experiment is [full-data training with pause and resume](docs/FULL_DATA_TRAINING.md): fresh random weights, all **251 speakers and 13,900 Libri2Mix train-100 mixtures**, and a **100-epoch schedule** using the efficient three-block model. Each user-started session stops after at most eight hours. [Live full-data progress](http://127.0.0.1:8000/experiments/full/) provides pause/resume controls and separate latest/best development results.
